...
get_gene_architecture<-function(tid,pst,pfi,ptr,utf,pre,hla,numsp,numcv){
  if(hla>0)
  {
...
mincv=1
for (hl in 0:3) {
  if(get_gene_architecture(transcript_id,path_status,path_file,path_tree,use_tree_features,path_to_results,hl,num_species,numcv))
  {break}
}
